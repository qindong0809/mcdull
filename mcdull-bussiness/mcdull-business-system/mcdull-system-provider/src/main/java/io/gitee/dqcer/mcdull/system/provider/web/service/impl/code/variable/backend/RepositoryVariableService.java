...
public class RepositoryVariableService extends CodeGenerateBaseVariableService {
    ...
    public Map<String, Object> getInjectVariablesMap(CodeGeneratorConfigForm form) {
        ...
        variablesMap.put("packageName", form.getBasic().getJavaPackageName() + ".dao.repository" );
