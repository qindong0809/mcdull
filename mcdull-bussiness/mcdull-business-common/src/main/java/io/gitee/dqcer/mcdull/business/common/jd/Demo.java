...
//        System.out.println(s);
        ...
        HttpResponse execute = HttpRequest.get(url)
                ...
                .header(Header.HOST, "def.m.jd.com")
                .header("TE", "trailers")
