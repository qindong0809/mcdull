...
import io.gitee.dqcer.mcdull.admin.util.dump.methods.EventDumper;
import io.gitee.dqcer.mcdull.admin.util.dump.methods.FunctionDumper;
import io.gitee.dqcer.mcdull.admin.util.dump.methods.ProcedureDumper;
import io.gitee.dqcer.mcdull.admin.util.dump.methods.TriggerDumper;
import io.gitee.dqcer.mcdull.admin.util.dump.util.DumpInfoUtility;
import io.gitee.dqcer.mcdull.admin.util.dump.util.SqlQueryUtility;
import io.gitee.dqcer.mcdull.admin.util.dump.util.SqlShowUtility;
...
public class SqlDumper {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        List<String> list = ListUtil.of("community");

        // 9e44c435d2498708c1781903c0bc753d
        Db db = MysqlUtil.getInstance("mcdull.io", 3306, "root", "123456", "mcdull-tmp");
        File file = dumpDatabase(db.getConnection(), new HashSet<>(list), "D://ddd.sql");
