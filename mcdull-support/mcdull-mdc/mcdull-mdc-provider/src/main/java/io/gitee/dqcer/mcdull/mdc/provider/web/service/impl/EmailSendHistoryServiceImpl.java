 ...
 */
@Service
public class EmailSendHistoryServiceImpl extends BasicServiceImpl<ISysEmailSendHistoryRepository>
    ...
    public boolean insert(List<String> sendToList, List<String> ccList, String title, String content) {
        ...
        SysEmailSendHistoryDO sendHistory = new SysEmailSendHistoryDO();
