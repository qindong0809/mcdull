...
INSERT INTO sys_role VALUES(1, '系统管理员', 'admin', '这是系统管理员', 2, 1589631293412503554, '2022-10-31 07:20:54', 1589631293412503554, '2022-12-05 22:53:42', '1', 1, null);
INSERT INTO sys_role VALUES(2, '日志管理员', 'log-admin', '这是日志管理员', 1, 1589631293412503554, '2022-10-31 07:20:54', 1589631293412503554, '2022-12-05 22:53:42', '1', 1, null);
...
insert into sys_menu values('6', '数据库管理', '0', '6', 'database',        null, '', 1, 0, 'M', '0', '1', 'database', 'example',   null, sysdate(), null, null, '数据库管理目录');

-- 二级菜单
insert into sys_menu values('600',  '实例管理', '6',   '6', 'instance',   'database/instance/index',  '', 1, 0, 'C', '0', '1', 'database:instance:list',  'list',      null, sysdate(), null, null, '实例管理菜单');
...
-- 用户管理按钮
insert into sys_menu values('1000', '查询', '100', '1',  '', '', '', 1, 0, 'F', '0', '1', 'system:user:query',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1001', '新增', '100', '2',  '', '', '', 1, 0, 'F', '0', '1', 'system:user:add',            '#', null, sysdate(), null, null, '');
insert into sys_menu values('1002', '修改', '100', '3',  '', '', '', 1, 0, 'F', '0', '1', 'system:user:edit',           '#', null, sysdate(), null, null, '');
insert into sys_menu values('1003', '删除', '100', '4',  '', '', '', 1, 0, 'F', '0', '1', 'system:user:remove',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1004', '导出', '100', '5',  '', '', '', 1, 0, 'F', '0', '1', 'system:user:export',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1005', '导入', '100', '6',  '', '', '', 1, 0, 'F', '0', '1', 'system:user:import',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1006', '重置密码', '100', '7',  '', '', '', 1, 0, 'F', '0', '1', 'system:user:resetPwd',       '#', null, sysdate(), null, null, '');
-- 角色管理按钮
insert into sys_menu values('1007', '查询', '101', '1',  '', '', '', 1, 0, 'F', '0', '1', 'system:role:query',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1008', '新增', '101', '2',  '', '', '', 1, 0, 'F', '0', '1', 'system:role:add',            '#', null, sysdate(), null, null, '');
insert into sys_menu values('1009', '修改', '101', '3',  '', '', '', 1, 0, 'F', '0', '1', 'system:role:edit',           '#', null, sysdate(), null, null, '');
insert into sys_menu values('1010', '删除', '101', '4',  '', '', '', 1, 0, 'F', '0', '1', 'system:role:remove',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1011', '导出', '101', '5',  '', '', '', 1, 0, 'F', '0', '1', 'system:role:export',         '#', null, sysdate(), null, null, '');
-- 菜单管理按钮
insert into sys_menu values('1012', '查询', '102', '1',  '', '', '', 1, 0, 'F', '0', '1', 'system:menu:query',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1013', '新增', '102', '2',  '', '', '', 1, 0, 'F', '0', '1', 'system:menu:add',            '#', null, sysdate(), null, null, '');
insert into sys_menu values('1014', '修改', '102', '3',  '', '', '', 1, 0, 'F', '0', '1', 'system:menu:edit',           '#', null, sysdate(), null, null, '');
insert into sys_menu values('1015', '删除', '102', '4',  '', '', '', 1, 0, 'F', '0', '1', 'system:menu:remove',         '#', null, sysdate(), null, null, '');
-- 部门管理按钮
insert into sys_menu values('1016', '查询', '103', '1',  '', '', '', 1, 0, 'F', '0', '1', 'system:dept:query',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1017', '新增', '103', '2',  '', '', '', 1, 0, 'F', '0', '1', 'system:dept:add',            '#', null, sysdate(), null, null, '');
insert into sys_menu values('1018', '修改', '103', '3',  '', '', '', 1, 0, 'F', '0', '1', 'system:dept:edit',           '#', null, sysdate(), null, null, '');
insert into sys_menu values('1019', '删除', '103', '4',  '', '', '', 1, 0, 'F', '0', '1', 'system:dept:remove',         '#', null, sysdate(), null, null, '');
-- 岗位管理按钮
insert into sys_menu values('1020', '查询', '104', '1',  '', '', '', 1, 0, 'F', '0', '1', 'system:post:query',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1021', '新增', '104', '2',  '', '', '', 1, 0, 'F', '0', '1', 'system:post:add',            '#', null, sysdate(), null, null, '');
insert into sys_menu values('1022', '修改', '104', '3',  '', '', '', 1, 0, 'F', '0', '1', 'system:post:edit',           '#', null, sysdate(), null, null, '');
insert into sys_menu values('1023', '删除', '104', '4',  '', '', '', 1, 0, 'F', '0', '1', 'system:post:remove',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1024', '导出', '104', '5',  '', '', '', 1, 0, 'F', '0', '1', 'system:post:export',         '#', null, sysdate(), null, null, '');
-- 字典管理按钮
insert into sys_menu values('1025', '查询', '105', '1', '#', '', '', 1, 0, 'F', '0', '1', 'system:dict:query',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1026', '新增', '105', '2', '#', '', '', 1, 0, 'F', '0', '1', 'system:dict:add',            '#', null, sysdate(), null, null, '');
insert into sys_menu values('1027', '修改', '105', '3', '#', '', '', 1, 0, 'F', '0', '1', 'system:dict:edit',           '#', null, sysdate(), null, null, '');
insert into sys_menu values('1028', '删除', '105', '4', '#', '', '', 1, 0, 'F', '0', '1', 'system:dict:remove',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1029', '导出', '105', '5', '#', '', '', 1, 0, 'F', '0', '1', 'system:dict:export',         '#', null, sysdate(), null, null, '');
-- 参数设置按钮
insert into sys_menu values('1030', '查询', '106', '1', '#', '', '', 1, 0, 'F', '0', '1', 'system:config:query',        '#', null, sysdate(), null, null, '');
insert into sys_menu values('1031', '新增', '106', '2', '#', '', '', 1, 0, 'F', '0', '1', 'system:config:add',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1032', '修改', '106', '3', '#', '', '', 1, 0, 'F', '0', '1', 'system:config:edit',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1033', '删除', '106', '4', '#', '', '', 1, 0, 'F', '0', '1', 'system:config:remove',       '#', null, sysdate(), null, null, '');
insert into sys_menu values('1034', '导出', '106', '5', '#', '', '', 1, 0, 'F', '0', '1', 'system:config:export',       '#', null, sysdate(), null, null, '');
-- 通知公告按钮
insert into sys_menu values('1035', '查询', '107', '1', '#', '', '', 1, 0, 'F', '0', '1', 'system:notice:query',        '#', null, sysdate(), null, null, '');
insert into sys_menu values('1036', '新增', '107', '2', '#', '', '', 1, 0, 'F', '0', '1', 'system:notice:add',          '#', null, sysdate(), null, null, '');
insert into sys_menu values('1037', '修改', '107', '3', '#', '', '', 1, 0, 'F', '0', '1', 'system:notice:edit',         '#', null, sysdate(), null, null, '');
insert into sys_menu values('1038', '删除', '107', '4', '#', '', '', 1, 0, 'F', '0', '1', 'system:notice:remove',       '#', null, sysdate(), null, null, '');
-- 操作日志按钮
...
insert into sys_config values(12, 'sql备份文件目录',   'database.sql.dump.directory',    '/opt/mc-dull/sql-dump',             'Y','设置上传sql备份文件目录',                null,  sysdate(), null, null, 1, null);
...
insert into sys_dict_type values(1,  '用户性别', 'sys_user_sex',        '1', null, sysdate(), null, null, '用户性别列表', 1, null);
insert into sys_dict_type values(2,  '菜单状态', 'sys_show_hide',       '1', null, sysdate(), null, null, '菜单状态列表', 1, null);
insert into sys_dict_type values(3,  '系统开关', 'sys_normal_disable',  '1', null, sysdate(), null, null, '系统开关列表', 1, null);
insert into sys_dict_type values(4,  '任务状态', 'sys_job_status',      '1', null, sysdate(), null, null, '任务状态列表', 1, null);
insert into sys_dict_type values(5,  '任务分组', 'sys_job_group',       '1', null, sysdate(), null, null, '任务分组列表', 1, null);
insert into sys_dict_type values(6,  '系统是否', 'sys_yes_no',          '1', null, sysdate(), null, null, '系统是否列表', 1, null);
insert into sys_dict_type values(7,  '通知类型', 'sys_notice_type',     '1', null, sysdate(), null, null, '通知类型列表', 1, null);
insert into sys_dict_type values(8,  '通知状态', 'sys_notice_status',   '1', null, sysdate(), null, null, '通知状态列表', 1, null);
insert into sys_dict_type values(9,  '操作类型', 'sys_oper_type',       '1', null, sysdate(), null, null, '操作类型列表', 1, null);
insert into sys_dict_type values(10, '系统状态', 'sys_common_status',   '1', null, sysdate(), null, null, '登录状态列表', 1, null);
...
`file_size` bigint(20) default null comment '大小',
...
drop table if exists `database_ticket`;
create table `database_ticket` (
`id` bigint not null comment '主键',
`name` varchar(128) not null comment '名称',
`number` varchar(64) not null comment '工单号',
`group_id` bigint not null comment '组号',
`execute_type` int not null comment '执行方式（1/停放执行 2/在线执行）',
...
drop table if exists `database_back_instance`;
create table `database_back_instance` (
`id` bigint not null comment '主键',
`back_id` bigint not null comment '所属业务主键',
...
drop table if exists `database_back`;
create table `database_back` (
`id` bigint not null comment '主键',
`name` varchar(128) not null comment '备注',
